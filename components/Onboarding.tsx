...
const SLIDES = [
  {
    ...
    description: 'Разложите сомнения на атомы. Наша система поможет увидеть скрытые факторы и принять решение, о котором вы не пожалеете.',
    icon: Zap,
  ...
  },
  {
    ...
    description: 'Запечатлевайте важные инсайты и моменты благодарности. Создайте личную базу мудрости, которая станет вашей опорой.',
    icon: BookOpen,
