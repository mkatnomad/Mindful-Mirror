...
import { Heart, BookOpen, ChevronRight, Settings, Info, User as UserIcon, Activity, Quote, Zap, Camera, Star, ArrowLeft, MessageSquare, Award, Medal, Sun, Sparkles } from 'lucide-react';
...
// --- ЛОГОТИП (Работает через папку public) ---
