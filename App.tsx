...
const App: React.FC = () => {
  ...
  const renderHome = () => {
    ...
    return (
      <div className={`h-full overflow-y-auto animate-fade-in relative z-10 pb-40 transition-colors duration-500 pt-top-safe ${userProfile.rpgMode ? 'bg-parchment ' : 'bg-transparent'}`}>
  ...
  const renderProfile = () => {
    ...
    return (
      <div className={`px-5 h-full overflow-y-auto pb-40 transition-colors duration-500 pt-top-safe ${userProfile.rpgMode ? 'bg-parchment ' : 'bg-transparent'}`}>
  ...
  const renderRanksInfo = () => (
    <div className={`h-full overflow-y-auto pb-40 transition-colors duration-500 pt-top-safe ${userProfile.rpgMode ? 'bg-parchment ' : 'bg-transparent'}`}>
      ...
      <main className="flex-1 relative overflow-hidden z-10">
        ...
        {currentView === 'ARCHETYPE_TEST' && (
           <div className={`h-full flex flex-col animate-fade-in transition-colors duration-500 relative overflow-hidden ${userProfile.rpgMode ? 'bg-parchment ' : 'bg-transparent'}`}>
             ...
             <header className="relative z-30 pt-top-safe px-6 mb-1 flex items-center justify-between pointer-events-none">
        ...
        {currentView === 'ARCHETYPE_GLOSSARY' && (
           <div className={`p-8 h-full overflow-y-auto animate-fade-in pb-40 transition-colors duration-500 pt-top-safe ${userProfile.rpgMode ? 'bg-parchment ' : 'bg-transparent'}`}>
        ...
        {currentView === 'HISTORY' && (
           <div className={`p-8 h-full overflow-y-auto pb-40 transition-colors duration-500 pt-top-safe ${userProfile.rpgMode ? 'bg-parchment ' : 'bg-transparent'}`}>
